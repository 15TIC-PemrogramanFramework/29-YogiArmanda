...
<body>
    ...
    <div class="main-agileits">
        <h1>Login Customer <br> ( <?php echo tanggalx();?> )</h1>
    ...
    <div class="w3copyright-agile">
        <p>© 2017 Flaty User <a href="Login">login</a> Form. All rights reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a></p>
    </div>
    <!-- //copyright --> 
    <script>
