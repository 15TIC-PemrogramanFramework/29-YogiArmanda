...
<?php $this->load->view('templates/headercustomer');?>
        <div class="row" style="margin-bottom: 20px">
            <div class="col-md-4">
                <span align="left"><a href="<?php echo site_url('LoginCustomer/logout'); ?>" class="btn btn-danger btn-flat">Keluar Dari Customer</a></span>
                <p>
                </p>
            </div>
        </div>
