	...
	<div class="agileits_header">
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					<li><a href="../logincustomer">Login Customer</a></li>
				</ul>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="../home">Cek Resi Yamukni</a></h1>
			</div>
...
<form action="<?php echo $action; ?>" method="post">
	<div class="form-group">
		...
		<input type="text" name="id_catalog" class="form-control" value="<?php echo $id_catalog;?>" placeholder="Masukkan Id Catalog" required>
	</div>
	<div class="form-group">
		<label>KATEGORI</label>
		<input type="text" name="kategori" class="form-control" value="<?php echo $kategori;?>" placeholder="Masukkan Kategori Barang" required>
	</div>
	<div class="form-group">
	...
	<a href="<?php echo site_url('catalog') ?>" class="btn btn-default">Cancel</a>
</form>
