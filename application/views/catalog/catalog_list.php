...
<div class="row">
	<div class="col-md-12 text-right">
		<div style="margin-top: 20px; margin-bottom: 10px;">
			<?php echo anchor(site_url('catalog/tambah'),
...
<table id="example" class="table table-striped table-bordered">
	...
	<tbody>
		<?php foreach ($data_catalog as $key => $row) { ?>
		<tr>
			<td><?php echo $row->id_catalog; ?></td>
			<td><?php echo $row->kategori; ?></td>
			<td><?php echo $row->nama_barang; ?></td>
			<td>
				<?php echo anchor(site_url('catalog/edit/'.$row->id_catalog),
				'<i class="fa fa-pencil"> </i>',
				'class="btn btn-warning"'); ?>
				<?php echo anchor(site_url('catalog/delete/'.$row->id_catalog),
